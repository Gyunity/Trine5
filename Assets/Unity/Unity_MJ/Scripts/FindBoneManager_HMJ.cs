...
public class FindBoneManager_HMJ : MonoBehaviour
{
    // 싱글톤 인스턴스
    private static FindBoneManager_HMJ _instance = null;
    ...
    public static FindBoneManager_HMJ Instance
    {
        get
        {
            if (null == _instance)
            {
                _instance = new FindBoneManager_HMJ();
            }
            return _instance;
        }
    }
